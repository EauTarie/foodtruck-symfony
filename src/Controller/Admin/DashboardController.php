...
use App\Entity\Plat;
use ContainerQsIvJn1\getUtilisateurCrudControllerService;
...
class DashboardController extends AbstractDashboardController
{
    ...
    public function configureMenuItems(): iterable
    {
        return [
            ...
            MenuItem::linkToCrud('Plat', 'fa fa-tags', Utilisateur::class)
            ->setPermission('ROLE_EDITOR'),
        ];
        // yield MenuItem::linkToDashboard('Retour à l\'accueil', 'fa fa-home', 'homepage');
